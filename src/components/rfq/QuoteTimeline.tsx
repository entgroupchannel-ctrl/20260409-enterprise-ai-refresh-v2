...
import { Check, Clock, Send, Package, CheckCircle2, XCircle, Upload } from "lucide-react";

// ✅ 5 steps: po_uploaded = po_confirmed (same step)
const steps = [
  ...
  { key: "po_approved", label: "อนุมัติแล้ว", icon: CheckCircle2 },
...
const badgeColors: Record<string, string> = {
  ...
  po_uploaded: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400",
  po_confirmed: "bg-purple-100 text-purple-800 dark:bg-purple-900/30 dark:text-purple-400",
