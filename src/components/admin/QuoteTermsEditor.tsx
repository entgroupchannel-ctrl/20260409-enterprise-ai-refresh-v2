          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
            ...
            <div className="space-y-1.5 md:col-span-2">
              ...
              <Textarea
                ...
                rows={2} disabled={disabled}
                className="flex min-h-[80px] w-full rounded-md px-3 py-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50 text-sm resize-none border border-input focus-visible:border-primary font-medium bg-slate-100 text-secondary-foreground"
              />
            </div>
