    ...
    <section className="relative min-h-screen flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex items-center px-6 md:px-12 lg:px-20">
        <div className="w-full flex flex-col lg:flex-row lg:items-center lg:justify-between gap-10 py-16 md:py-0">
          ...
          <div className={`hidden lg:flex fixed right-0 top-1/2 -translate-y-1/2 z-[60] transition-all duration-500 ease-in-out ${tagsExpanded ? "translate-x-0" : "translate-x-[calc(100%-28px)]"}`}>
            <button
              type="button"
