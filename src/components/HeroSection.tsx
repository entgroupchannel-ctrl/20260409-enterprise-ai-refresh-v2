...
import { Search, Menu, X, ChevronDown, LogIn, UserCircle, LayoutDashboard, LogOut, FileText, Plus, User, Tag, Mail, ShoppingCart, ArrowRight, Flame, MessageCircle } from "lucide-react";
    ...
    <section className="relative min-h-screen flex flex-col">
      ...
      <Popover>
        ...
        <PopoverContent align="end" side="top" className="w-64 p-2">
          <button
            type="button"
            onClick={() => window.dispatchEvent(new CustomEvent("ent:open-chat"))}
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-sm font-semibold">เปิดแชท</span>
              <span className="text-[11px] text-muted-foreground">คุยกับทีมขายตอนนี้</span>
            </div>
          </button>
          <Link
            to="/contact"
          ...
          >
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-sm font-semibold">ไปหน้าติดต่อ</span>
              <span className="text-[11px] text-muted-foreground">เบอร์โทร · อีเมล · แผนที่</span>
            </div>
          </Link>
        </PopoverContent>
      </Popover>
