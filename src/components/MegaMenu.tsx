...
const menuCategories = [
    ...
    columns: [
      {
        ...
        links: [
          { label: "แนะนำ NVIDIA Jetson", href: "/nvidia-jetson", hot: true },
          ...
          { label: "Embedded IPC / Edge AI", href: "/nvidia-jetson/products?cat=embedded-systems" },
          { label: "GPU Server & Workstation", href: "/nvidia-jetson/gpu-server" },
          { label: "Professional Graphics Card", href: "/nvidia-jetson/professional-gpu" },
        ],
      },
      {
        heading: "โซลูชัน & ตัวอย่างใช้งาน",
        links: [
          ...
          { label: "Robot / Drone / Medical", href: "/nvidia-jetson/solutions#drone" },
          { label: "Case Studies", href: "/nvidia-jetson/case-studies" },
        ],
      },
      {
        heading: "หาเครื่องมือ & ปรึกษา",
        links: [
  ...
  },
  {
    id: "display",
    label: "Smart Display",
    tagline: "KIOSK & จอใหญ่อุตสาหกรรม",
    icon: Tv,
    featured: {
      title: "Interactive Touch Display & KIOSK",
      desc: "KIOSK 15.6\"–23.8\" + จอทัชสกรีนใหญ่ 27\"–98\" — เลือกขนาดให้เหมาะกับงาน พร้อมส่งเร็ว",
    ...
    columns: [
      {
        ...
        links: [
          { label: '15.6" Floor Kiosk (KD156B)', href: "/products/displays-15.6", new2026: true },
      ...
      {
        heading: "📺 Big Screen Display — จอใหญ่",
        links: [
          { label: '27" – 32" Conference', href: "/products/displays-27", hot: true },
          { label: '43" – 55" Smart Classroom', href: "/products/displays-55" },
          { label: '65" – 75" Boardroom', href: "/products/displays-75" },
          { label: '86" – 98" Auditorium', href: "/products/displays-86", hot: true },
          { label: "เปรียบเทียบทุกขนาด →", href: "/interactive-display#products" },
        ],
      },
      {
        heading: "📡 Signage / Outdoor / Industrial",
        links: [
          { label: 'Digital Signage 35"–75"', href: "/smart-display" },
          { label: 'Outdoor 12"–32" (1500 Nits)', href: "/smart-display?tab=outdoor" },
          { label: 'TouchWork 8"–21.5"', href: "/touchwork", new2026: true },
          { label: "Stainless Steel IP69K", href: "/smart-display" },
          { label: "Touch Monitor FPM Series", href: "/fpm-series" },
          { label: "Accessories — ขาตั้ง / ขายึด", href: "/accessories" },
        ],
      },
    ],
  },
