    ...
    columns: [
      {
        ...
        links: [
          ...
          { label: "Developer Kits", href: "/nvidia-jetson/products?cat=devkits", hot: true },
          { label: "Carrier Boards", href: "/nvidia-jetson/products?cat=carrier-boards" },
      ...
      },
      {
        ...
        links: [
          { label: "✦ ตัวช่วยเลือกรุ่น Jetson (Wizard)", href: "/nvidia-jetson/recommend", hot: true },
