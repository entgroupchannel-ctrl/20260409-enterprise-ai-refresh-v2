...
const footerSections: { title: string; links: FooterLink[] }[] = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: "🎯 ตัวช่วยเลือกสินค้า (Advisor)", href: "/product-advisor" },
  ...
  },
  {
    ...
    links: [
      ...
      { label: "⚖️ เปรียบเทียบสินค้า", href: "/shop/compare" },
      { label: "📝 ขอใบเสนอราคา", href: "/request-quote" },
      { label: "🛡️ ลงทะเบียนสินค้า (Warranty)", href: "/my/products/register" },
