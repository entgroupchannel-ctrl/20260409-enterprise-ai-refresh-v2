...
const IPCTech = lazyRetry(() => import("./pages/IPCTech"));
...
const ShopTouchworkDM156G = lazyRetry(() => import("./pages/shop/ShopTouchworkDM156G"));
const ShopTouchworkDM17G = lazyRetry(() => import("./pages/shop/ShopTouchworkDM17G"));
const ShopTouchworkDM19G = lazyRetry(() => import("./pages/shop/ShopTouchworkDM19G"));
const ShopTouchworkDM215G = lazyRetry(() => import("./pages/shop/ShopTouchworkDM215G"));
const ShopTouchworkGD133 = lazyRetry(() => import("./pages/shop/ShopTouchworkGD133"));
const ShopTouchworkGD156 = lazyRetry(() => import("./pages/shop/ShopTouchworkGD156"));
const ShopTouchworkGD156E = lazyRetry(() => import("./pages/shop/ShopTouchworkGD156E"));
const ShopTouchworkJD133 = lazyRetry(() => import("./pages/shop/ShopTouchworkJD133"));
...
const ShopEpcS10X2A = lazyRetry(() => import("./pages/shop/ShopEpcS10X2A"));
const ShopEpcS12X2A = lazyRetry(() => import("./pages/shop/ShopEpcS12X2A"));
const ShopEpcS15X2A = lazyRetry(() => import("./pages/shop/ShopEpcS15X2A"));
const ShopEpcS17X2A = lazyRetry(() => import("./pages/shop/ShopEpcS17X2A"));
const ShopEpcS19X2A = lazyRetry(() => import("./pages/shop/ShopEpcS19X2A"));
                ...
                <Suspense fallback={<PageLoader />}>
                  <Routes>
                   ...
                   <Route path="/products/interactive-display-hd49" element={<Navigate to="/products/displays-49?model=hd49" replace />} />
                    ...
                    <Route path="/shop/dm15g" element={<ShopTouchworkDM15G />} />
                    <Route path="/shop/dm156g" element={<ShopTouchworkDM156G />} />
                    ...
                    <Route path="/shop/gd156e" element={<ShopTouchworkGD156E />} />
                    ...
                    <Route path="/shop/epc-s10x2a" element={<ShopEpcS10X2A />} />
                    <Route path="/shop/epc-s12x2a" element={<ShopEpcS12X2A />} />
                    <Route path="/shop/epc-s15x2a" element={<ShopEpcS15X2A />} />
                    <Route path="/shop/epc-s17x2a" element={<ShopEpcS17X2A />} />
                    <Route path="/shop/epc-s19x2a" element={<ShopEpcS19X2A />} />
