      ...
      products: [
        {
          ...
          details: {
            ...
            environment: {
              ...
              housing: "Aluminum (IP30 Protection)",
              mounting: "DIN-Rail",
              dimensions: "50 x 161.5 x 119.9 mm",
              weight: "970 g (2.14 lb)",
            },
            standards: [
              "IEEE 802.3 / 802.3u / 802.3ab / 802.3z (10/100/1000BASE-T, FX, SX/LX)",
              "IEEE 802.3af/at/bt (PoE / PoE+ / PoE++ Type 3/4)",
              "IEEE 802.3az (EEE), 802.3x (Flow Control), 802.1ad (Link Aggregation/QinQ)",
              "IEEE 802.1D/w/s (STP/RSTP/MSTP), 802.1p (CoS), 802.1Q (VLAN)",
              "IEEE 802.1X (Port Auth), 802.1AB (LLDP), 1588v2 (PTP)",
            ],
            certifications: ["UL", "CE", "FCC", "ROHS", "NEMA TS2"],
