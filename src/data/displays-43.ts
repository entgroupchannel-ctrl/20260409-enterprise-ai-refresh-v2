...
export const DISPLAYS_43: Record<Display43Slug, Display32> = {
  ...
  kd43b: {
    ...
    highlights: [
      { icon: "Layers", title: "Interchangeable Front Panel", subtitle: "เปลี่ยนหน้ากากเพิ่ม Printer / Scanner ได้" },
      { icon: "Maximize", title: "ตู้ตั้งพื้น 45° Tilt", subtitle: "Ergonomic Unibody Design" },
      { icon: "Hand", title: "PCAP 10-Point Touch", subtitle: "Mohs class 7 explosion-proof glass" },
      { icon: "ShieldCheck", title: "Lockable Rear Panel", subtitle: "Powder-coated Steel กันสนิม 24/7" },
    ],
    features: [
      "Industry-First Replaceable Front Panel — เปลี่ยนหน้ากากในไม่กี่นาที",
      "ดีไซน์ Unibody เอียง 45° — Ergonomic ใช้งานได้สบายทั้งยืนและนั่ง",
      "Lockable Rear Panel — บำรุงรักษาง่ายแต่ปลอดภัย",
      "Powder-coated Steel Housing — กันสนิมและรอยขีดข่วน",
      "Industrial-grade Power Supply — รองรับ 7×24H Stable Working",
      "30,000-hour LED Backlight Lifetime",
      "Optional Pre-drilled Holes สำหรับยึดพื้นถาวร",
      "Customizable: Body shape / Colors / Logo Integration",
    ],
    useCases: ["Retail Self-checkout", "Banking / ATM Lobby", "Exhibition / Wayfinding", "QSR Self-order"],
    useCaseScenarios: [
      { image: hd43UcSelforder,   title: "Retail Self-checkout / QSR Kiosk",  description: "ตู้สั่งอาหาร / จ่ายเงินด้วยตนเองในร้าน QSR และร้านค้าปลีก เปลี่ยน Front Panel เพิ่ม Receipt Printer + Card Reader ได้ทันทีโดยไม่ต้องเปลี่ยนตู้ใหม่" },
      { image: hd43UcReception,   title: "Banking / ATM Lobby",                description: "จุดบริการสมาชิกธนาคาร / Mini-bank ในศูนย์การค้า เพิ่มหน้ากาก Fingerprint + Passport Scanner สำหรับยืนยันตัวตน KYC ได้" },
      { image: hd43UcRestaurant,  title: "Exhibition / Wayfinding",            description: "ตู้ค้นหาข้อมูลในงานแสดงสินค้า ห้างสรรพสินค้า และอาคารสำนักงาน — UI เรียบง่ายไม่ต้องฝึกอบรมพนักงาน รองรับการใช้งานหนักในพื้นที่สาธารณะ" },
      { image: hd43UcMeeting,     title: "Healthcare / Hospital Check-in",     description: "ตู้ลงทะเบียนผู้ป่วยในโรงพยาบาล กระจกกันระเบิด Mohs 7 ทำความสะอาดด้วยน้ำยาฆ่าเชื้อได้ไม่เป็นรอย ปลอดภัยและถูกสุขอนามัย" },
    ],
    gallery: [
    ...
    variants: [
      {
        key: "monitor",
        label: "KD43B — Touch Monitor",
        badge: "เฉพาะจอสัมผัส (ไม่มี PC ในตัว)",
        osBackground: "none",
        icon: "Monitor",
        description:
          "ตู้คีออสก์ 43\" PCAP เฉพาะจอสัมผัส — ต่อกับ External PC / Mini PC / Media Player ผ่าน HDMI + USB Touch เหมาะกับลูกค้าที่มีระบบ POS / Signage Player อยู่แล้ว และต้องการเฉพาะตู้ตั้งพื้นพร้อมจอสัมผัส",
        bestFor: "ลูกค้ามีระบบ PC/POS อยู่แล้ว ต้องการเฉพาะตู้ Floor-Stand + จอสัมผัส 43\"",
        highlights: [
          "PCAP 10-Point Touch + Mohs class 7 glass",
          "Brightness 300 cd/m² + 30,000-hr LED",
          "USB 2.0 + Power Socket สำหรับต่อ External PC",
          "Plug-and-play กับ Windows / Linux / macOS",
        ],
        accent: "neutral",
      },
      {
        key: "x86",
        label: "KD43B — Windows / Linux PC",
        badge: "All-in-One Kiosk PC (x86)",
        osBackground: "windows",
        icon: "Cpu",
        description:
          "ตู้คีออสก์ All-in-One จอ 43\" พร้อม PC x86 ภายใน เลือก CPU ได้ 3 ระดับ — Intel Celeron J6412 (Entry), Core i5-8th (Mid), Core i7-10th (High) ติดตั้ง Windows 10/11 หรือ Linux จากโรงงาน รองรับซอฟต์แวร์ POS / KIOSK / ERP เต็มรูปแบบ",
        bestFor: "Self-checkout / Self-service ที่ใช้ซอฟต์แวร์ Windows-based",
        highlights: [
          "Intel Celeron J6412 / Core i5-8th / Core i7-10th",
          "DDR4-2666 RAM 4 / 8 / 16 GB + mSATA 128 / 256 / 512 GB",
          "Pre-install Windows 10 / 11 / Linux",
          "Gigabit RJ45 + Wi-Fi 802.11ac + ALC269 HD Audio",
        ],
        cpu: "Intel Celeron J6412 / Core i5-8th / Core i7-10th",
        ram: "4 / 8 / 16 GB",
      ...
      {
        key: "android",
        label: "KD43B — Android PC",
        badge: "All-in-One Kiosk PC (ARM)",
        osBackground: "android",
        icon: "Smartphone",
        description:
          "ตู้คีออสก์ All-in-One จอ 43\" พร้อม Rockchip ARM ภายใน เลือก CPU ได้ 3 ระดับ — RK3568 / RK3288 / RK3588 ติดตั้ง Android 11 / 9 / 12 จากโรงงาน Power Consumption ต่ำกว่า 115W เหมาะกับงาน Self-service Kiosk และ Digital Signage",
        bestFor: "Self-service Kiosk / Digital Signage ที่ใช้ Android App",
        highlights: [
          "Rockchip RK3568 / RK3288 / RK3588 (เลือกได้)",
          "RAM 4GB (4G opt) / 2GB / 4GB (8G opt)",
          "eMMC 32GB / 16GB / 64-128GB",
          "Pre-install Android 11 / 9 / 12 + 802.11ac Wi-Fi",
        ],
        cpu: "Rockchip RK3568 / 3288 / 3588",
        ram: "2–8 GB",
        storage: "eMMC 16–128 GB",
        accent: "secondary",
      },
    ],
    cpuOptions: [
      {
        ...
        ram: "DDR4-2666 SODIMM 4GB",
        storage: "mSATA 128GB",
        targetUseCase: "Self-checkout เบสิก / Digital Signage",
      },
      {
        tier: "Mid",
        cpu: "Intel® Core™ i5 (8th Gen)",
        ...
        ram: "DDR4-2666 SODIMM 8GB",
        storage: "mSATA 256GB",
        targetUseCase: "QSR Self-order / Banking Kiosk / Hospital Check-in",
      },
      {
        tier: "High",
        cpu: "Intel® Core™ i7 (10th Gen)",
        ...
        ram: "DDR4-2666 SODIMM 16GB",
        storage: "mSATA 512GB",
        targetUseCase: "Multi-tasking Kiosk / AI Vision / KYC + Document Scan",
      },
    ],
    datasheetUrl: "https://touchwo.com/wp-content/uploads/2024/11/KD43B-X86-TouchWo-SpecSheet.pdf",
    ports: [
      "Power Socket × 1", "USB 2.0 × 2", "RJ45 × 1", "Wi-Fi Antenna × 1",
    ],
    specs: [
      { title: "PC System (Windows / Linux x86)", rows: [
        ...
        { label: "Audio", value: "HD Audio: ALC269" },
        { label: "หน่วยความจำ (RAM)", value: "DDR4-2666 SODIMM 4GB / 8GB / 16GB" },
        { label: "หน่วยเก็บข้อมูล", value: "mSATA 128GB / 256GB / 512GB" },
        { label: "เครือข่าย", value: "10/100/1000M RJ45 + Wi-Fi 802.11a/b/g/n/ac" },
        { label: "OS ที่ติดตั้งให้", value: "Windows 10 / 11 / Linux (เลือกได้)" },
      ]},
      { title: "Android System (ARM)", rows: [
        { label: "CPU (เลือกได้)", value: "Rockchip RK3568 / RK3288 / RK3588" },
        { label: "Graphic GPU", value: "ARM G52 2EE / Mali-T864 / Mali-G610" },
        { label: "หน่วยความจำ (RAM)", value: "4GB (4G opt) / 2GB / 4GB (8G opt)" },
        { label: "หน่วยเก็บข้อมูล", value: "eMMC 32GB / 16GB / 64-128GB" },
        { label: "เครือข่าย", value: "10/100M หรือ Gigabit RJ45 + Wi-Fi 802.11a/b/g/n/ac" },
        { label: "OS ที่ติดตั้งให้", value: "Android 11 / Android 9 / Android 12" },
      ]},
      { title: "LCD Panel", rows: [
        { label: "ขนาดหน้าจอ", value: "43 นิ้ว" },
      ...
      { title: "Power Supply", rows: [
        ...
        { label: "Standby Power", value: "≤ 0.5W" },
        { label: "Overall Power", value: "Android < 115W / x86 < 140W" },
      ]},
      { title: "Dimension & Weight (ตัวตู้ตั้งพื้น)", rows: [
        { label: "ขนาดเครื่อง (W×H×D)", value: "65 × 187.15 × 45 cm" },
        { label: "ขนาดกล่อง (W×H×D)", value: "75 × 196.5 × 55 cm" },
        { label: "น้ำหนักสุทธิ", value: "57 kg" },
        { label: "น้ำหนักรวม", value: "65 kg" },
      ]},
      { title: "Included in the Delivery", rows: [
        { label: "Manual / คู่มือ", value: "× 1" },
        { label: "Key (กุญแจล็อกฝาหลัง)", value: "× 2" },
        { label: "Wi-Fi Antenna", value: "× 1 (รุ่น AIO)" },
    ...
    quick: {
      ...
      touch: "PCAP 10pt + Mohs 7",
      os: "Monitor / Windows / Linux / Android (เลือกได้)",
      formFactor: "Floor-Stand Kiosk (Unibody 45° Tilt)",
      dimensionCm: "65 × 187.15 × 45",
      weightKg: "57",
      power: "< 140W",
      install: "Floor Stand (Optional Pre-drilled Bolts)",
    },
  },
};

export const DISPLAY_43_ORDER: Display43Slug[] = ["hd43", "hr43", "kd43b"];
