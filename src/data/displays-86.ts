/**
 * Touch Display 86" — RZ86B Configurable AIO (Monitor / Windows OPS / Android)
 * แหล่งสเปก: touchwo.com (RZ86B Series)
 *  - RZ86B Touch Monitor:    https://touchwo.com/product/elo-monitor-86-touch-monitor-rz86b/
 *  - RZ86B Touch PC (x86):   https://touchwo.com/product/elo-monitor-86-touch-pc-rz86b/
 *  - RZ86B Android Touch PC: https://touchwo.com/product/elo-monitor-86-android-touch-pc-rz86b/
 *
 * โครงสร้างซีรีส์เดียวกับ RZ85B แต่ใช้ Panel 86" 4K UHD (Active 1893.4 × 1064.9 mm)
...
import rz86Monitor from "@/assets/touchwo/rz86b/p-monitor.jpg";
import rz86Windows from "@/assets/touchwo/rz86b/p-windows.jpg";
import rz86Android from "@/assets/touchwo/rz86b/p-android.jpg";
import rz86P1 from "@/assets/touchwo/rz86b/p-1.jpg";
import rz86P3 from "@/assets/touchwo/rz86b/p-3.jpg";
import rz86P4 from "@/assets/touchwo/rz86b/p-4.jpg";
import rz86P5 from "@/assets/touchwo/rz86b/p-5.jpg";
import rz86P6 from "@/assets/touchwo/rz86b/p-6.jpg";
import rz86P7 from "@/assets/touchwo/rz86b/p-7.jpg";
import rz86Io from "@/assets/touchwo/rz86b/io.jpg";
import rz86Feat1 from "@/assets/touchwo/rz86b/feat-1.png";
import rz86Feat2 from "@/assets/touchwo/rz86b/feat-2.png";
import rz86Feat3 from "@/assets/touchwo/rz86b/feat-3.png";
import rz86Feat4 from "@/assets/touchwo/rz86b/feat-4.png";
import rz86InstallFloor from "@/assets/touchwo/rz86b/install-floor.png";
import rz86InstallWall from "@/assets/touchwo/rz86b/install-wall.png";
import rz86InstallAcc from "@/assets/touchwo/rz86b/install-acc.png";

import rz86UcClassroom from "@/assets/touchwo/usecases/rz86b/uc-classroom.jpg";
import rz86UcBoardroom from "@/assets/touchwo/usecases/rz86b/uc-boardroom.jpg";
import rz86UcWayfinding from "@/assets/touchwo/usecases/rz86b/uc-wayfinding.jpg";
import rz86UcIndustrial from "@/assets/touchwo/usecases/rz86b/uc-industrial.jpg";
import rz86UcShowroom from "@/assets/touchwo/usecases/rz86b/uc-showroom.jpg";
import rz86UcHotel from "@/assets/touchwo/usecases/rz86b/uc-hotel.jpg";

export type Display86Slug = "rz86b";
export { OS_BACKGROUNDS };
export type { OSKey };

export const DISPLAYS_86: Record<Display86Slug, Display32> = {
  rz86b: {
    slug: "rz86b",
    modelCode: "RZ86B",
    name: '86" RZ86B Series — Touch Monitor / Windows OPS / Android PC',
    shortName: "RZ86B Series",
    category: "86\" 4K UHD Touch Display (Modular Smart Terminal)",
    formFactor: "Configurable AIO",
    tagline: "จอสัมผัสขนาดยักษ์ 86\" 4K UHD PCAP — Modular Plug-and-Play — เลือก 3 Configuration: Monitor / Windows OPS / Android",
    description:
      "RZ86B คือจอสัมผัสขนาดยักษ์ 86 นิ้ว ความละเอียด 4K UHD 3840×2160 พร้อมเทคโนโลยี PCAP 10-point — ออกแบบเป็น Modular Smart Terminal เปลี่ยนระหว่าง Monitor / Windows / Android ได้ง่ายแบบ Plug-and-Play พร้อม Embedded Tempered Glass + Front-Facing Speakers ให้เสียงคมชัดส่งตรงสู่ผู้ใช้ — ผิวสัมผัส Mohs class 7 explosion-proof, Contrast 5000:1 มุมมอง 178°/178° พื้นที่แสดงผล 1893.4 × 1064.9 mm — ตัวเครื่องบางเพียง 9.3 cm รองรับการติดตั้ง Wall-mount หรือ Floor-standing เลือก Configuration ได้ 3 แบบ: (1) Touch Monitor ต่อ External PC, (2) Windows All-in-One พร้อม OPS — Intel Core i3-4Gen / i5-10Gen / i7-11Gen, (3) Android All-in-One พร้อม Rockchip RK3568 / RK3288 / RK3588",
    highlights: [
      { icon: "Maximize", title: "86\" 4K UHD 3840×2160", subtitle: "16:9 / 350 cd/m² / Contrast 5000:1" },
    ...
    useCases: ["Auditorium 86\"", "Executive Boardroom", "Mall Wayfinding", "Industrial SCADA", "Premium Showroom", "Hotel Concierge"],
    useCaseScenarios: [
      {
        image: rz86UcClassroom,
        title: "Auditorium / Lecture Hall — ห้องบรรยายขนาดใหญ่",
        description:
          "จอสัมผัส 4K UHD 86\" สำหรับห้องบรรยายขนาดใหญ่และ Auditorium — มองเห็นชัดทุกมุมห้องแม้นั่งหลังห้อง 50+ ที่นั่ง PCAP 10-point รองรับการเขียนหลายมือพร้อมกัน Mohs 7 ทนการกดเขียนต่อเนื่อง เหมาะกับ Active Learning ห้องเรียนตั้งแต่ 50 ที่นั่งขึ้นไป",
      },
      {
        image: rz86UcBoardroom,
        title: "Executive Boardroom — ห้องประชุมผู้บริหาร",
        description:
          "จอ 86\" 4K UHD แสดงผล Dashboard / Financial Charts / Video Conference ได้คมชัดในห้องประชุมขนาดใหญ่ — รองรับ OPS PC Intel Core i7-11Gen + Wireless Presentation Front-facing Speaker เสียงตรงสู่โต๊ะประชุม Modular Design อัปเกรด PC ได้ในอนาคต",
      },
      {
        image: rz86UcWayfinding,
        title: "Mall / Airport Wayfinding — ตู้แผนที่นำทาง",
        description:
          "ตู้นำทางขนาดใหญ่ในห้างสรรพสินค้า สนามบิน หรืออาคารราชการ — แผนที่ 4K UHD เห็นรายละเอียดชัด เลือกเส้นทาง พิมพ์ QR Code นำทาง ติดตั้งแบบ Wall-mount ได้ทันที PCAP รองรับการใช้งานหนาแน่น 24/7",
      },
      {
        image: rz86UcIndustrial,
        title: "Industrial SCADA — Control Room ขนาดใหญ่",
        description:
          "Dashboard ควบคุมโรงงานขนาดใหญ่ — แสดง KPI, OEE, Machine Status, Andon Board แบบ Real-time จอ 4K UHD 86\" เห็นข้อมูลละเอียดจากระยะไกลทั่วทั้งห้องควบคุม Industrial Power 24/7 รองรับการสัมผัสด้วยถุงมือ",
      },
      {
        image: rz86UcShowroom,
        title: "Premium Showroom — Product Configurator",
        description:
          "จอ Configurator 86\" 4K UHD แสดงผลผลิตภัณฑ์พรีเมียมในขนาดเสมือนจริง — ลูกค้าเลือกสี รุ่น ออปชัน ดูภายใน-ภายนอก แบบ 360° Front-facing Speaker เสริมประสบการณ์ด้วยเสียงนำเสนอ ส่งเสริมการตัดสินใจซื้อ",
      },
      {
        image: rz86UcHotel,
        title: "Hotel Lobby Concierge — Digital Directory",
        description:
          "จอ 86\" Wall-mount ในล็อบบี้โรงแรม — Directory ห้องอาหาร, สปา, Activities, Local Attractions พร้อม Map เห็นภาพชัดในระยะ 5-15 เมตร Mohs 7 ทนการสัมผัสต่อเนื่อง รองรับหลายภาษา (Multi-language UI)",
      },
    ],
    gallery: [rz86P1, rz86Monitor, rz86Windows, rz86Android, rz86P3, rz86P4, rz86P5, rz86P6, rz86P7],
    ioImage: rz86Io,
    installImages: [rz86InstallFloor, rz86InstallWall, rz86InstallAcc],
    featureImages: [rz86Feat1, rz86Feat2, rz86Feat3, rz86Feat4],
    dimensionDrawings: [
      {
        image: rz86P3,
        title: "Mechanical Dimension — 86\" 4K Modular Display",
        caption: "ตัวเครื่อง 86\" 4K UHD — ขนาด 1954 × 1153 × 93 mm (กว้าง × สูง × ลึก) Active Area 1893.4 × 1064.9 mm น้ำหนักสุทธิ 63 kg / รวม 74 kg — ดีไซน์ Modular Smart Terminal สามารถเปลี่ยน OPS PC หรือ Android Module ได้ง่ายแบบ Plug-and-Play",
        callouts: [
          { label: "ขนาดเครื่อง", value: "195.4 × 115.3 × 9.3 cm" },
          { label: "Active Area", value: "1893.4 × 1064.9 mm" },
          { label: "น้ำหนักสุทธิ / รวม", value: "63 kg / 74 kg" },
          { label: "ขนาดกล่อง", value: "207 × 129 × 21.5 cm" },
        ],
      },
      {
        image: rz86Io,
        title: "I/O Layout — RZ86B Series",
        caption: "ผังพอร์ต I/O รวมของ RZ86B — ครอบคลุมทั้ง 3 Configuration (Monitor / Windows OPS / Android) — รองรับ HDMI, VGA, USB, RJ45, RS232, Audio, Touch out, AV in/out, Coaxial, RF",
        callouts: [
    ...
    variants: [
      {
        key: "monitor",
        label: "RZ86B — Touch Monitor",
        badge: "เฉพาะจอสัมผัส (ไม่มี PC ในตัว)",
        osBackground: "none",
        icon: "Monitor",
        description:
          "จอสัมผัส 86\" 4K UHD PCAP ล้วน ๆ ดีไซน์ Modular — ต่อกับ External PC, OPS หรือ Media Player ผ่าน HDMI input + VGA + USB Touch (Plug-and-play) พร้อม Embedded Tempered Glass + Front-facing Speakers — Power Output DC 12V 5A น้ำหนักสุทธิ 63 kg มาพร้อม Wall mount bracket, Power & USB & HDMI cable, Remote control",
        bestFor: "ลูกค้ามี PC/OPS อยู่แล้ว ต้องการเฉพาะจอสัมผัสขนาดยักษ์ 86\" 4K UHD แบบ Modular",
        highlights: [
      ...
      {
        key: "x86",
        label: "RZ86B — Windows / Linux PC (OPS)",
        badge: "All-in-One PC (OPS Architecture)",
        osBackground: "windows",
        icon: "Cpu",
        description:
          "All-in-One PC จอ 86\" 4K UHD พร้อม OPS Slot ภายใน เลือก CPU ได้ 3 ระดับ — Intel Core i3 4-Gen (Entry) / Core i5 10-Gen (Mid) / Core i7 11-Gen (High) — RAM Kingston 4-16GB + Seagate SSD 128-512GB ติดตั้ง Windows 10/11 หรือ Linux จากโรงงาน — ดีไซน์ Modular เปลี่ยน OPS ได้ในอนาคต พร้อม Refresh Rate 60Hz",
      ...
      {
        key: "android",
        label: "RZ86B — Android PC",
        badge: "All-in-One PC (ARM)",
        osBackground: "android",
        icon: "Smartphone",
        description:
          "All-in-One PC จอ 86\" 4K UHD พร้อม Rockchip ARM ภายใน เลือก CPU ได้ 3 ระดับ — RK3568 (Android 11) / RK3288 (Android 9) / RK3588 (Android 12) พร้อม Wi-Fi 802.11ac — เหมาะกับ Education App, Public Self-service และ Digital Signage 4K ขนาดยักษ์",
    ...
    datasheetUrl: "https://touchwo.com/wp-content/uploads/2024/11/RZ86B-Monitor-TouchWo-SpecSheet-1.pdf",
    ports: [],
    specs: [
      ...
      { title: "LCD Panel", rows: [
        { label: "ขนาดหน้าจอ", value: "86 นิ้ว" },
        { label: "ความละเอียด", value: "3840 × 2160 (4K UHD)" },
        { label: "อัตราส่วนภาพ", value: "16 : 9" },
        { label: "พื้นที่แสดงผล", value: "1893.4 × 1064.9 mm" },
      ...
      { title: "Dimension & Weight", rows: [
        ...
        { label: "ขนาดกล่อง (L×W×H)", value: "207 × 129 × 21.5 cm" },
...
export const DISPLAY_86_ORDER: Display86Slug[] = ["rz86b"];

export const getDisplay86 = (slug: string): Display32 | undefined =>
  DISPLAYS_86[slug as Display86Slug];
