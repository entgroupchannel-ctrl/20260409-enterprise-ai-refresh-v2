  ...
  kd32b: {
    ...
    cpuOptions: [
      ...
      },
      {
        ...
        ram: "DDR4 SODIMM 8GB",
        storage: "SSD 256GB",
        targetUseCase: "ระบบ Queue / Check-in, ERP / CRM Front-end",
      },
      {
        tier: "High",
        cpu: "Intel® Core™ i7-10th Gen",
        gpu: "Intel® UHD Graphics",
        ram: "DDR4 SODIMM 16GB",
        storage: "SSD 512GB",
        targetUseCase: "Industrial HMI, AI / Vision, Multi-tasking",
      },
      {
        tier: "Entry",
        cpu: "Rockchip RK3568 (ARM, Android)",
        gpu: "Mali-G52",
        ram: "LPDDR4 2GB",
        storage: "eMMC 16GB",
        targetUseCase: "Android Signage, Wayfinding, Self-service พื้นฐาน",
      },
      {
        tier: "Mid",
        cpu: "Rockchip RK3288 (ARM, Android)",
        gpu: "Mali-T764",
        ram: "LPDDR4 4GB",
        storage: "eMMC 32GB",
        targetUseCase: "Android POS, Queue, Interactive Kiosk",
      },
      {
        tier: "High",
        cpu: "Rockchip RK3588 (8-core, ARM)",
        gpu: "Mali-G610 MP4",
        ram: "LPDDR4 8GB",
        storage: "eMMC 128GB",
        targetUseCase: "Android AI Vision, 4K Signage, Multi-camera",
      },
    ],
    peripherals: KIOSK_PERIPHERALS,
    customizationLeadTime: KIOSK_CUSTOMIZATION_LEAD_TIME,
