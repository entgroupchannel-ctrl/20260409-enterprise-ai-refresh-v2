...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'Affiliate Program', icon: Award, path: '/admin/affiliate', hiddenFromRoles: ['warehouse', 'viewer'] },
  ...
  },
  {
    ...
    items: [
      ...
      { label: 'นักลงทุน', icon: Shield, path: '/admin/investors', superAdminOnly: true },
