        ...
        <div className="grid md:grid-cols-3 gap-5">
          {(["Monitor", "ARM", "X86"] as TouchWorkArch[]).map((a) => {
            ...
            const meta = {
              Monitor: {
                title: "Monitor",
                sub: "จอสัมผัสล้วน — มีหลายขนาด",
                desc: "ต่อกับ PC/Mini PC ผ่าน HDMI/VGA — เลือกขนาดได้ตั้งแต่ 8\" – 21.5\" เพื่อให้พอดีกับงานติดตั้ง",
                use: "ขนาดที่มี: 8\" / 10.1\" / 12.1\" / 13.3\" / 15.6\" / 17\" / 18.5\" / 19\" / 21.5\"",
              ...
              ARM: {
                title: "ARM (Android)",
                sub: "Touch PC พร้อมใช้ — รัน Application ในตัว",
                desc: "มาพร้อม Android 11/13 ในตัว ประหยัดไฟ ใช้แอป Kiosk, Booking, Self-Order ได้ทันทีโดยไม่ต้องต่อ PC",
                use: "Application: Meeting Room Booking, Self-Order, Queue, Digital Menu, ตู้ถ่ายรูป",
                image: archArmImg,
              ...
              X86: {
                ...
                use: "Application: POS ร้านอาหาร, ERP, MES โรงงาน, SCADA, ระบบจัดการคลัง",
                image: archX86Img,
