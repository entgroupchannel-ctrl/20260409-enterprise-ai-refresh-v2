...
export default function AdminSaleOrders() {
  ...
  return (
    <AdminLayout>
      <AdminPageLayout
        title="ยอดขาย / Order"
        description="จัดการคำสั่งซื้อและติดตามสถานะการส่งสินค้า"
        searchPlaceholder="ค้นหาเลขที่ออเดอร์, ชื่อ, อีเมล, บริษัท..."
        ...
        statsTabs={[
          ...
          { label: 'กำลังจัดเตรียม', value: 'in_production', count: statusCounts.in_production || 0 },
      ...
      >
        ...
        {filteredOrders.length === 0 ? (
          <EmptyState
            ...
            description="ยังไม่มีคำสั่งซื้อในระบบ หรือลองเปลี่ยนตัวกรอง"
          />
        ) : (
