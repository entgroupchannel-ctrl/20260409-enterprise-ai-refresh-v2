...
import epcXaMachineVision from "@/assets/epc-xa-usecases/07-machine-vision.jpg";
import epcXaRetail from "@/assets/epc-xa-usecases/02-retail-kiosk.jpg";
...
const epcCompData = {
  ...
  prices: {
    "ราคาเริ่มต้น (Celeron J6412)": ["฿13,990", "฿13,990", "฿13,990", "฿13,990"],
    "ราคา Celeron J1900": ["฿14,990", "฿14,990", "฿14,990", "฿14,990"],
    "ราคา i3 Gen10": ["฿30,990", "฿30,990", "฿30,990", "฿30,990"],
    "ราคา i5 Gen10": ["฿36,990", "฿36,990", "฿36,990", "฿36,990"],
    "ราคา i7 Gen10": ["฿39,990", "฿39,990", "฿39,990", "฿39,990"],
    "ราคา i3 Gen12": ["฿30,990", "฿30,990", "฿30,990", "฿30,990"],
    "ราคา i5 Gen12": ["฿35,990", "฿35,990", "฿35,990", "฿35,990"],
    "ราคา i7 Gen12": ["฿39,990", "฿39,990", "฿39,990", "฿39,990"],
