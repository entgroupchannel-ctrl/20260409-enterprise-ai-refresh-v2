        ...
        <div className="container max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            <div className="card-surface p-4 flex flex-col items-center gap-3 relative">
              <img src={gty121Front} alt="GTY121T ด้านหน้า — จอสัมผัส Windows 11" className="w-full max-h-[280px] object-contain rounded-lg"/>
            ...
            <div className="card-surface p-4 flex flex-col items-center gap-3 justify-end relative">
              <div className="flex-1 flex items-end">
                <img src={gty156Front} alt="GTY156T — มุมเอียง แสดงครีบระบายความร้อน Fanless" className="w-full max-h-[280px] object-contain rounded-lg"/>
              </div>
              <div className="text-center">
            ...
            {[
              ...
              <div key={item.title} className="card-surface overflow-hidden group hover:border-primary/30 transition-all hover:-translate-y-1">
                <div className="relative h-48 overflow-hidden">
                  <img src={item.img} alt={item.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" width={800} height={512}/>
        ...
        <div className="container max-w-7xl mx-auto">
          <div className="card-surface overflow-hidden p-6 md:p-10">
            <div className="grid lg:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex justify-center">
                <img src={gtgSeries} alt="GTG Panel PC" className="max-h-[300px] object-contain"/>
              </div>
            </div>
          </div>
        </div>
