      ...
      if (!error && data) {
        ...
        if (productIds.length > 0) {
          ...
          const panelBoxSeeds: PanelBoxSeed[] = [
            ...
            { id: 'epc-w24x2a', model: 'EPC-W24X2A', series: 'EPC Panel PC', desc: '23.6" 16:9 — จอใหญ่สุดของ Wide Series', image: '/images/wix/0597a3_cfe6c90e6ba44ef3ba3a0aa5a698f32d_2b0c00e1.png', href: '/epc-series#wide' },
