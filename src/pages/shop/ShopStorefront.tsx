...
const ShopStorefront = () => {
        ...
        if (productIds.length > 0) {
          ...
          const staticProducts: Product[] = [
            ...
            },
            {
              ...
              description: 'จอสัมผัสอุตสาหกรรม 10.1" 16:10 PCAP 10pt Mohs 7 IP65 (หน้า) — เลือกได้ทั้ง Monitor (HDMI/VGA), Android (RK3568/RK3399) และ Windows (Intel Celeron / Core i3-i7) • รองรับ Resolution Upgrade 1920×1200 HD+',
              category: 'Industrial Touch PC',
              cpu: 'Plug & Play / RK3568 / Intel (TBD)',
              ram_gb: 4,
              storage_gb: 32,
            ...
            },
            {
              ...
              description: 'จอสัมผัสอุตสาหกรรม 17" 5:4 (1280×1024) Capacitive 10pt — Tempered Glass 7H, Backlight 30,000 ชม., IP65 ด้านหน้า ขนาดใหญ่อ่านง่ายเหมาะกับห้องควบคุม / SCADA • เลือกได้ทั้ง Monitor (HDMI/VGA), Android (RK3568/RK3399) และ Windows (Intel Celeron / Core i3-i7) — กรณีไม่ระบุ CPU Model แจ้งแอดมินขอราคา',
              category: 'Industrial Touch PC',
              cpu: 'Plug & Play / RK3568 / Intel (TBD)',
              ram_gb: 4,
              storage_gb: 32,
              ...
              is_active: true,
              slug: 'dm17g',
              tags: ['new', 'touch-pc', 'industrial', '17-inch', '5-4', 'tempered-7h'],
              is_featured: true,
              variant_count: 3,
              starting_price: 15990,
              warranty_months: 12,
            ...
            },
            {
              ...
              sku: 'GD133-TOUCHPC',
              model: 'GD133',
              series: 'Wall-Mount Touch PC',
              name: 'TouchWork 13.3" Wall-Mount Touch PC IPS Full HD (Monitor / Android / Windows)',
              description: 'จอสัมผัสอุตสาหกรรม 13.3" 16:9 Full HD (1920×1080) IPS 178°/178° Capacitive 10pt — บางเฉียบ 42.8 mm สำหรับ Wall-Mount โรงแรม/ออฟฟิศ/Meeting Room • IP65 ด้านหน้า, Wi-Fi 5 + BT 4.2, รองรับ VESA 75 • เลือกได้ทั้ง Monitor (HDMI/VGA), Android 11/13 (RK3568) และ Windows 10/11 (Intel) — กรณีไม่ระบุ CPU Model แจ้งแอดมินขอราคา',
              category: 'Wall-Mount Touch PC',
              cpu: 'Plug & Play / RK3568 / Intel (TBD)',
              ram_gb: 4,
              storage_gb: 32,
              storage_type: 'eMMC / SSD',
            ...
            },
            {
              ...
              description: 'จอสัมผัสอุตสาหกรรม 15.6" 16:9 Full HD (1920×1080) IPS 178°/178° • Active Area 344×194 mm • PCAP 10pt scan 200Hz, 4096×4096, แม่นยำ >1.5mm • ผิวกระจก Mohs 7 กันระเบิด • Bezel บางพิเศษ 13 mm, ความหนา 42.8 mm • ทำงาน 7×24 ชม. • ไฟ 110-240V AC → DC 12V 5A, Standby ≤0.5W (Android <36W) • Compatible: Square / Stripe / Clover / Shopify POS • เลือกได้ทั้ง Monitor (HDMI/VGA), Android 11/12 (RK3568) และ Windows 10/11 (Intel)',
              ...
              is_active: true,
              slug: 'gd156',
              tags: ['new', 'touch-kiosk', 'wall-mount', '15.6-inch', '16-9', 'full-hd', 'ips', 'pos', 'mohs-7'],
              is_featured: true,
              variant_count: 3,
              starting_price: 16990,
              warranty_months: 12,
            ...
            },
            {
              ...
              description: 'จอสัมผัสอุตสาหกรรม 21.5" 16:9 (1920×1080) Full HD IPS 175°/175° Capacitive 10pt — จอใหญ่ราคาประหยัด เหมาะกับงาน Kiosk / Self-Service / Reception • IP65 ด้านหน้า, Wi-Fi 5 + BT 4.2, รองรับ VESA 100 + Desktop • เลือกได้ทั้ง Monitor (HDMI/VGA), Android 11/13 (RK3568) และ Windows 10/11/Linux — กรณีไม่ระบุ CPU Model แจ้งแอดมินขอราคาเป็นกรณี',
              category: 'Indoor Display Touch PC',
              cpu: 'Plug & Play / RK3568 / Intel (TBD — แจ้งแอดมิน)',
              ram_gb: 4,
              storage_gb: 64,
              ...
              unit_price: 17990,
              unit_price_vat: null,
              image_url: jd215bHero,
              thumbnail_url: jd215bHero,
              gallery_urls: null,
              stock_status: 'available',
              is_active: true,
              slug: 'jd215b',
              tags: ['new', 'touch-pc', 'indoor-display', '21.5-inch', '16-9', 'ips', 'full-hd', 'kiosk'],
              is_featured: true,
              variant_count: 3,
              starting_price: 17990,
              warranty_months: 12,
          ...
          const upcSeeds: UpcSeed[] = [
            ...
            { id: 'epc-202b', model: 'EPC-202B', tag: 'EPC', cpu: '12th Gen Intel® Core™', highlight: '7× COM Port', feature: 'Multi-serial port สำหรับงานควบคุมอุปกรณ์อุตสาหกรรมจำนวนมาก', image: '/upc-images/2025_12_WechatIMG3926.png', popular: true },
          ...
          const panelBoxSeeds: PanelBoxSeed[] = [
            ...
            { id: 'epc-s15x2a', model: 'EPC-S15X2A', series: 'EPC Panel PC', desc: '15" 4:3 SXGA — Popular Standard Panel PC', image: '/images/products/s15x2a/front.webp', href: '/epc-series#standard', popular: true },
            { id: 'epc-s17x2a', model: 'EPC-S17X2A', series: 'EPC Panel PC', desc: '17" 4:3 SXGA 1280×1024 — SCADA Panel PC', image: '/images/products/s17x2a/front.webp', href: '/epc-series#standard' },
            { id: 'epc-s19x2a', model: 'EPC-S19X2A', series: 'EPC Panel PC', desc: '19" 4:3 SXGA 1280×1024 — Largest Standard Panel PC', image: '/images/products/s19x2a/front.webp', href: '/epc-series#standard' },
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Floating compare bar — centered to avoid overlap with chat FAB */}
      {compareList.length > 0 && (
        <div className="fixed bottom-4 sm:bottom-6 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-1.5rem)] sm:w-auto max-w-md">
          <div className="flex items-center gap-2 sm:gap-3 px-3 sm:px-4 py-2.5 rounded-full bg-background/95 backdrop-blur border border-primary/30 shadow-2xl">
            <div className="flex items-center gap-2 min-w-0">
              <span className="hidden sm:inline text-xs text-muted-foreground whitespace-nowrap">เลือกแล้ว</span>
              ...
              <span className="text-xs text-muted-foreground whitespace-nowrap">/ 4 รายการ</span>
            </div>
            <Button
              variant="ghost"
              size="sm"
              className="h-8 px-2 text-xs"
              onClick={() => { setCompareListState([]); setCompareList([]); }}
            >
              ล้าง
            </Button>
            <Link to={`/shop/compare?products=${compareList.join(',')}`} className="shrink-0">
              <Button size="sm" className="h-9 px-4 gap-1.5 rounded-full shadow-md">
                เปรียบเทียบ
              </Button>
            </Link>
          </div>
    ...
    <Card className="group hover:shadow-xl hover:border-primary/30 hover:-translate-y-1 transition-all duration-200 border-border relative overflow-hidden">
      <CardContent className="p-0">
        ...
        <button
          ...
          className={cn(
            'absolute top-2 left-20 z-10 h-7 w-7 rounded-full flex items-center justify-center bg-background/85 backdrop-blur border border-border shadow-sm transition-colors',
